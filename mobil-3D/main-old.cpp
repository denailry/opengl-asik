...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // glm::vec4 rightColor = texture2D(bufferTexture,vec2(pixel.x+xPixel,pixel.y));
        // glm::vec4 leftColor = texture2D(bufferTexture,vec2(pixel.x-xPixel,pixel.y));
        // glm::vec4 upColor = texture2D(bufferTexture,vec2(pixel.x,pixel.y+yPixel));
        // glm::vec4 downColor = texture2D(bufferTexture,vec2(pixel.x,pixel.y-yPixel));
        //Diffuse equation
