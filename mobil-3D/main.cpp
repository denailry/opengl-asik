...
int main()
{
    ...
    // ------------------------------------
    Shader ourShader("camera/camera.vs", "camera/camera.fs");
    Shader lightingShader("lightning/basic_lighting.vs", "lightning/basic_lighting.fs");
    ...
    // 1rst attributef bufer : vertices
